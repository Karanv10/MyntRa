...
public class ProfileFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if (ee!="0"){
            getActivity().getSupportFragmentManager().beginTransaction().replace(R.id.profile_container,new ProfileSecFragment()).commit();
        }
            ...
            public void onClick(View view) {
                            ...
                            public void onResponse(String response) {
                                    ...
                                    try {
                                        ...
                                        if (ms.equals("1")) {
                                            ...
                                            getActivity().getSupportFragmentManager().beginTransaction().replace(R.id.profile_container,new ProfileSecFragment()).addToBackStack(null).commit();
                                            sheetDialog.dismiss();
                ...
                view1.findViewById(R.id.sheet_signup).setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        getActivity().getSupportFragmentManager().beginTransaction().replace(R.id.hide_container,new RegisterFragment()).addToBackStack(null).commit();
                        sheetDialog.dismiss();
                    }
                });
                ...
                view1.findViewById(R.id.forgotPassword).setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        getActivity().getSupportFragmentManager().beginTransaction().replace(R.id.hide_container,new ForgetFragment()).addToBackStack(null).commit();
                        sheetDialog.dismiss();
