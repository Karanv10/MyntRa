    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        txt_p11.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                getFragmentManager().beginTransaction().replace(R.id.hide_container,new SizeFragment()).addToBackStack(null).commit();
        ...
        txt_p12.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                getFragmentManager().beginTransaction().replace(R.id.hide_container,new EmiFragment() ).addToBackStack(null).commit();
        ...
        cart.setOnClickListener(new View.OnClickListener() {
           ...
           //   String cmeasure=measure.getText().toString();
               ...
               getFragmentManager().beginTransaction().replace(R.id.hide_container,new CartFragment()).addToBackStack(null).commit();
